...
const addJobItemStart = html.indexOf('function defaultJobItemRate(type)');
...
const lineItemTypeContext = { state:{settings:{default_labor_rate:125,diagnostic_rate:150}}, jobItems:[{ type:'labor', qty:2.5, rate:125, taxable:0 }], renderJobItems(){} };
...
assert.match(html, /const TYPES = \['labor','diagnostic','part','parts','shop_supply','fee','sublet'\]/, 'job editing must represent every supported estimate and repair-order line type');
